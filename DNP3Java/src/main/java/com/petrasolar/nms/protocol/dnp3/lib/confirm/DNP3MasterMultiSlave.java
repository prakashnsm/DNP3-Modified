...
import org.totalgrid.reef.protocol.dnp3.AppConfig;
import org.totalgrid.reef.protocol.dnp3.ExceptionScan;
...
import org.totalgrid.reef.protocol.dnp3.LinkConfig;
import org.totalgrid.reef.protocol.dnp3.MasterConfig;
...
import org.totalgrid.reef.protocol.dnp3.VectorOfExceptionScan;
...
public class DNP3MasterMultiSlave extends ResponseAcceptor implements Runnable {
	...
	private long aNumRetry = 3;
	private long aFragSize = (5 * 1024);
	...
	public void run() {
		...
		ILogBase logger = DNP3Logger.getInstance();
